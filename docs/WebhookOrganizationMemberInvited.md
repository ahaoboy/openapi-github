...
**invitation** | [**models::WebhookOrganizationMemberInvitedInvitation**](webhook_organization_member_invited_invitation.md) |  | 
...
**user** | Option<[**models::WebhooksUser**](webhooks_user.md)> |  | [optional]
