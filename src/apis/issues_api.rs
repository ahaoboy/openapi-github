...
pub async fn issues_slash_get_comment(configuration: &configuration::Configuration, owner: &str, repo: &str, comment_id: i32) -> Result<models::IssueComment, Error<IssuesSlashGetCommentError>> {
    let local_var_configuration = configuration;
...
pub async fn issues_slash_remove_assignees(configuration: &configuration::Configuration, owner: &str, repo: &str, issue_number: i32, issues_remove_assignees_request: models::IssuesRemoveAssigneesRequest) -> Result<models::Issue, Error<IssuesSlashRemoveAssigneesError>> {
    let local_var_configuration = configuration;
...
pub async fn issues_slash_update_comment(configuration: &configuration::Configuration, owner: &str, repo: &str, comment_id: i32, issues_update_comment_request: models::IssuesUpdateCommentRequest) -> Result<models::IssueComment, Error<IssuesSlashUpdateCommentError>> {
    let local_var_configuration = configuration;
