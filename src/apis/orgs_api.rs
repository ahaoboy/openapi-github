...
pub async fn orgs_slash_create_custom_organization_role(configuration: &configuration::Configuration, org: &str, orgs_create_custom_organization_role_request: models::OrgsCreateCustomOrganizationRoleRequest) -> Result<models::OrganizationRole, Error<OrgsSlashCreateCustomOrganizationRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_create_or_update_custom_properties(configuration: &configuration::Configuration, org: &str, orgs_create_or_update_custom_properties_request: models::OrgsCreateOrUpdateCustomPropertiesRequest) -> Result<Vec<models::OrgCustomProperty>, Error<OrgsSlashCreateOrUpdateCustomPropertiesError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_create_or_update_custom_property(configuration: &configuration::Configuration, org: &str, custom_property_name: &str, orgs_create_or_update_custom_property_request: models::OrgsCreateOrUpdateCustomPropertyRequest) -> Result<models::OrgCustomProperty, Error<OrgsSlashCreateOrUpdateCustomPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_get_all_custom_properties(configuration: &configuration::Configuration, org: &str) -> Result<Vec<models::OrgCustomProperty>, Error<OrgsSlashGetAllCustomPropertiesError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_get_custom_property(configuration: &configuration::Configuration, org: &str, custom_property_name: &str) -> Result<models::OrgCustomProperty, Error<OrgsSlashGetCustomPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_list_org_role_teams(configuration: &configuration::Configuration, org: &str, role_id: i32, per_page: Option<i32>, page: Option<i32>) -> Result<Vec<models::Team>, Error<OrgsSlashListOrgRoleTeamsError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_list_org_role_users(configuration: &configuration::Configuration, org: &str, role_id: i32, per_page: Option<i32>, page: Option<i32>) -> Result<Vec<models::SimpleUser>, Error<OrgsSlashListOrgRoleUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_list_organization_fine_grained_permissions(configuration: &configuration::Configuration, org: &str) -> Result<Vec<models::OrganizationFineGrainedPermission>, Error<OrgsSlashListOrganizationFineGrainedPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn orgs_slash_patch_custom_organization_role(configuration: &configuration::Configuration, org: &str, role_id: i32, orgs_patch_custom_organization_role_request: models::OrgsPatchCustomOrganizationRoleRequest) -> Result<models::OrganizationRole, Error<OrgsSlashPatchCustomOrganizationRoleError>> {
    let local_var_configuration = configuration;
