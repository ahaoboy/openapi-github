...
pub async fn gists_slash_get_comment(configuration: &configuration::Configuration, gist_id: &str, comment_id: i32) -> Result<models::GistComment, Error<GistsSlashGetCommentError>> {
    let local_var_configuration = configuration;
...
pub async fn gists_slash_update_comment(configuration: &configuration::Configuration, gist_id: &str, comment_id: i32, gists_create_comment_request: models::GistsCreateCommentRequest) -> Result<models::GistComment, Error<GistsSlashUpdateCommentError>> {
    let local_var_configuration = configuration;
