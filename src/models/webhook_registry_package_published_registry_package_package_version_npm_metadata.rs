...
pub struct WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata {
    ...
    pub author: Option<Option<Box<models::Deployment1Payload>>>,
    #[serde(rename = "bugs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub bugs: Option<Option<Box<models::Deployment1Payload>>>,
    ...
    pub dist: Option<Option<Box<models::Deployment1Payload>>>,
    ...
    pub repository: Option<Option<Box<models::Deployment1Payload>>>,
    ...
    pub directories: Option<Option<Box<models::Deployment1Payload>>>,
