...
impl Issue7 {
    ...
    pub fn new(active_lock_reason: Option<ActiveLockReason>, assignees: Vec<models::User>, author_association: AuthorAssociation, body: Option<String>, closed_at: Option<String>, comments: i32, comments_url: String, created_at: String, events_url: String, html_url: String, id: i64, labels_url: String, milestone: Option<models::Milestone>, node_id: String, number: i32, reactions: models::Reactions, repository_url: String, title: String, updated_at: String, url: String, user: Option<models::User>) -> Issue7 {
        Issue7 {
            active_lock_reason,
            assignee: None,
            assignees,
