...
impl MarketplacePurchase1 {
    pub fn new(account: models::WebhooksMarketplacePurchaseAccount, billing_cycle: String, free_trial_ends_on: Option<String>, on_free_trial: bool, plan: models::WebhooksPreviousMarketplacePurchasePlan, unit_count: i32) -> MarketplacePurchase1 {
