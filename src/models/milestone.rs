...
impl Milestone {
    ...
    pub fn new(closed_at: Option<String>, closed_issues: i32, created_at: String, creator: Option<models::User1>, description: Option<String>, due_on: Option<String>, html_url: String, id: i32, labels_url: String, node_id: String, number: i32, open_issues: i32, state: State, title: String, updated_at: String, url: String) -> Milestone {
        Milestone {
            closed_at,
            closed_issues,
            created_at,
