...
impl RenamedIssueEvent {
    /// Renamed Issue Event
    pub fn new(id: i32, node_id: String, url: String, actor: models::SimpleUser, event: String, commit_id: Option<String>, commit_url: Option<String>, created_at: String, performed_via_github_app: Option<models::NullableIntegration>, rename: models::RenamedIssueEventRename) -> RenamedIssueEvent {
        RenamedIssueEvent {
            id,
            node_id,
            url,
