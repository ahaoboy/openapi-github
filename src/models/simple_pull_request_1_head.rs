...
pub struct SimplePullRequest1Head {
    ...
    pub repo: Option<Box<models::Repository8>>,
    #[serde(rename = "sha")]
    pub sha: String,
...
impl SimplePullRequest1Head {
    pub fn new(label: String, r#ref: String, repo: Option<models::Repository8>, sha: String, user: Option<models::User>) -> SimplePullRequest1Head {
