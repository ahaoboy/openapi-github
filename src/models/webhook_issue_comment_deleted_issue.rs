...
pub struct WebhookIssueCommentDeletedIssue {
    ...
    pub url: String,
    #[serde(rename = "user")]
    pub user: Box<models::WebhooksSponsorshipMaintainer>,
}
