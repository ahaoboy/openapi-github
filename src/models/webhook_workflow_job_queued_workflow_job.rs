...
pub struct WebhookWorkflowJobQueuedWorkflowJob {
    ...
    #[serde(rename = "steps")]
    pub steps: Vec<models::WorkflowStep3>,
    #[serde(rename = "url")]
    pub url: String,
}

impl WebhookWorkflowJobQueuedWorkflowJob {
    pub fn new(check_run_url: String, completed_at: Option<String>, conclusion: Option<String>, created_at: String, head_sha: String, html_url: String, id: i32, labels: Vec<String>, name: String, node_id: String, run_attempt: i32, run_id: f64, run_url: String, runner_group_id: Option<i32>, runner_group_name: Option<String>, runner_id: Option<i32>, runner_name: Option<String>, started_at: String, status: Status, head_branch: Option<String>, workflow_name: Option<String>, steps: Vec<models::WorkflowStep3>, url: String) -> WebhookWorkflowJobQueuedWorkflowJob {
